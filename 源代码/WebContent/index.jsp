...
%>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <form action="UserLoginServlet" method="get" name="form1" onSubmit="return login()">
      <table width="50%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <th height="70" colspan="2" class="ld" scope="col">在校大学生贷款系统</th>
		  </tr>
          <tr>
          ...
          <tr>
            <th height="35" colspan="2" scope="row" class="ln"><input class="submit" type="submit" value="登录">&nbsp;&nbsp;<input class="submit" type="button" value="注册" onClick="reg()"></th>
</tr>
        </table>
      </form>
      </td>
